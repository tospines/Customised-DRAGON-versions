...
void DRAGON::Run() {
  ...
  //sprintf(ascii_filename,"/proj/dmsearches/users/x_pedde/outputs/%s.txt",in->filename.c_str());
  ...
  for (vector<TParticle*>::reverse_iterator current_part = particles.rbegin(); current_part != particles.rend(); ++current_part) {
    ...
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -999 &&  (*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Ter_pbar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -998 && !(*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Sec_Dbar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -998 &&  (*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Ter_Dbar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -997 && !(*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Sec_He3bar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -997 &&  (*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Ter_He3bar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -996 && !(*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Sec_He4bar     " ;
    if ( !((*current_part)->IsDM()) && (*current_part)->GetUid() == -996 &&  (*current_part)->GetIsSec()  &&  !(*current_part)->IsExtra() )
      outfile << "Ter_He4bar     " ;
