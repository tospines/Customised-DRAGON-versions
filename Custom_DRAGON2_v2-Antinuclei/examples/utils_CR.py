...
class CR():
    ...
    def modul(E, flux, Z, A, phi_nuc, Antip=False, phi_n= 0.7, fluxerr = 0):
        if Z==1 and A==1:
            m = CR.m_p
        else:
            m = CR.m_u
    ...
    def modulEl(E, flux, phi_nuc, Antip=False, phi_n= 0.7, fluxerr = 0):
    ...
    def Rig_to_En(R, A, Z, flux, errflux, El=False):
        if Z==1 and A==1:
            m = CR.m_p
        else:
            m = CR.m_u
    ...
    def En_to_Rig(E, A, Z, flux, errflux, El=False):
