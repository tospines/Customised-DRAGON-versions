...
public:
  ...
  void InitLeptUser(double, Input*);
  void InitXSecWinkler(double, Input*);
  //void InitXSecWinkler(double);
  
  void InitXSecDRAGONAN(double, TGalpropXSec, string, string, string, string, string, string, bool, bool, string);
  //void InitXSecDRAGONAN(TGrid*, Input*, double, string, string, string, string, string, string);
