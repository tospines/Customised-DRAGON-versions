...
private:
  ...
  int QueryIntAttributeWithDefault(string, TiXmlElement*, int);
  ...
  string QueryStringAttributeWithDefault(string, TiXmlElement*, string);
...
public:
  ...
  bool prop_Adeuteron; /**< Whether to propagate antideuterons. */
  bool prop_AHe3; /**< Whether to propagate antiHe3. */
  bool prop_AHe4; /**< Whether to propagate antiHe4. */
  bool prop_lep; /**< Whether to propagate electrons and positrons. */
  bool prop_secap; /**< Whether to propagate antiprotons. */
  bool prop_secAdeuteron; /**< Whether to propagate secondary antideuterons. */
  bool prop_secAHe3; /**< Whether to propagate secondary antiHe3. */
  bool prop_secAHe4; /**< Whether to propagate secondary antiHe4. */
  ...
  bool prop_DMdeuteron, prop_DMHe3, prop_DMHe4; /**< Whether to propagate antideuterons. */
  ...
  double SA_cut_diff, SA_cut_convec, SA_cut_vA, SA_cut_source, SA_cut_DMsource, SA_cut_gasH2, SA_cut_gasHI, SA_cut_gasHII, SA_cut_MagField, SA_cut_ISRF;
   ...
   double Delta_delta; /**< difference of power law index of energy dependence of diffusion coefficient in the halo (delta_disk + D_d = delta_halo). */
   string Disk_table;
   string Halo_table;
   double normDisk;
   double normHalo;
   ...
   bool BreakDiff, DoubleBreak, TwoZoneModel, Diff_table, VariableD, OneZone_interp, Double_b, LowE_b; 
   double delta_H, rho_H, s_H, delta_L, rho_L, s_L;
  ...
  double El_A_Scal, Pos_A_Scal;
  AntiprotonYields apy;
  AntinucleiYields any;
  double Ap_A_Scal, Ap_XS_Scal;
  double BXS_Scale, BeXS_Scale, LiXS_Scale, FXS_Scale;
  ...
  std::string User_pp_Pos, User_pHe_Pos, User_Hep_Pos, User_HeHe_Pos;
  std::string User_pp_El, User_pHe_El, User_Hep_El, User_HeHe_El;
  ...
  //Antinuclei
  bool AN_DRAGON_IneXSec; // Either the user wants to use the DRAGON inelastic cross sections or directly give the tables with inclusive XSecs
  bool Scale_pAd, Scale_pAHe3, Scale_pAHe4; // Use p+p-> Anti-D cross sections table and scale that to predict cross sections from ap and He collisions
  std::string Adtable_pp, Adtable_pHe, Adtable_Hep, Adtable_HeHe, Adtable_app, Adtable_apHe;
  std::string AHe3table_pp, AHe3table_pHe, AHe3table_Hep, AHe3table_HeHe, AHe3table_app, AHe3table_apHe;
  std::string AHe4table_pp, AHe4table_pHe, AHe4table_Hep, AHe4table_HeHe, AHe4table_app, AHe4table_apHe;
  ...
  string MySelfTableDMdbar, MySelfTableDMHe3bar, MySelfTableDMHe4bar;
