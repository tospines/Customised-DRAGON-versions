...
public:
    ...
    //modified
  virtual void Run(vector<double>&, vector<double>&, TInelasticCrossSection*, const vector<double>&, const vector<double>&, const vector<double>&, double, double, double, int, std::vector<int>& nuclei, bool SecEl=false, int K_electron=0, bool isDM=false, bool isextra=false)=0;

    virtual void Run(vector<double>&, vector<double>&, TInelasticCrossSection*, const vector<double>&, const vector<double>&, const vector<double>&, TDiffusionCoefficient*, TReaccelerationCoefficient*, double, double, double, int, std::vector<int>& nuclei, bool SecEl=false, int K_electron=0, bool isDM=false, bool isextra=false )=0;
    ...
    double CalcInjFactor(int K_electron, bool SecEl, bool isDM, double A, double Z) {
        ...
        else if (A > 0) return gal->GetSourceAbundance( (Z<-1) ? int(-1000+A): int(A+1000*Z) )/A;  //int(A+1000*Z)
        else return 1.0;
    }
...
protected:
    ...
    Input* in;
    //TNucleiList* mynuclist;
    std::vector<int> mynuclist;
...
public:
    ...
    //modified
    virtual void Run(vector<double>&, vector<double>&, TInelasticCrossSection* /**< Inelastic cross section */, const vector<double>& /**< Energy losses */, const vector<double>& /**< Secondary source contribution */, const vector<double>& /**< Injection spectrum */, double /**< Mass number */, double /**< Charge */, double /**< Lifetime */, int /**< Unique ID of daughter nucleus */, std::vector<int>&, bool SecEl=false /**< Whether it is a secondary electron, or proton, in which case the primary source term has to be 0. Default is false. */, int K_electron=0/*K_electron*/, bool isDM=false, bool isextra=false);
    virtual void Run(vector<double>&, vector<double>&, TInelasticCrossSection* /**< Inelastic cross section */, const vector<double>&, const vector<double>&, const vector<double>&, TDiffusionCoefficient*, TReaccelerationCoefficient*, double, double, double, int, std::vector<int>&, bool SecEl=false, int K_electron=0, bool isDM=false, bool isextra=false) { /*...*/ }
...
public:
    ...
    virtual void Run(vector<double>&, vector<double>&, TInelasticCrossSection* /**< Inelastic cross section */, const vector<double>&, const vector<double>&, const vector<double>&, double, double, double, int, std::vector<int>&, bool SecEl=false, int K_electron=0 /** K electron */, bool isDM=false, bool isextra=false);  /**< Actually solve the transport equation and return the propagated density. */
